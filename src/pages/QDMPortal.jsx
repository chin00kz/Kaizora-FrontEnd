  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          <h1 className="text-3xl font-black text-[#4c1d95] tracking-tight">QDM Review Portal</h1>
          <p className="text-slate-500 font-medium">Evaluate, score, and guide corporate improvement initiatives.</p>
        </div>
      </div>
